    ...
    <article className="ranking-card">
      ...
      <div className="ranking-main">
        <div className="ranking-title-row">
          <div><span className="result-kind">Processo SEI</span><h3>{result.processNumber}</h3></div>
        ...
        <div className="ranking-actions">
          ...
          <button type="button" onClick={() => onOpenDocuments(result)}><FileText size={16} /> {result.documents.length} documentos-chave <FolderOpen size={16} /></button>
        </div>
