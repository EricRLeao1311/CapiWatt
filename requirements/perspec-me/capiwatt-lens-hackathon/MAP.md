...
**Backend:** tracker — Wayfinder map: [CapiWatt Lens — Caso 1 (Carolina): mapa de decisões](https://github.com/EricRLeao1311/CapiWatt/issues/1)
...
_Counts are of Concerns touched under this Map, by current `status` on their Resolution page. Last refreshed 2026-09-18 (issue #6 pages integrated with the local resolutions of issues #7, #8 and #9)._
...
| D — Data | 0 | 0 | 3 | 0 | 0 | 0 | 0 | _(none yet)_ |
